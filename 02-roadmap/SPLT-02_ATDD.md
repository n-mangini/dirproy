...
- [ ] **Registro de usuario:** Una persona puede crear una cuenta en la plataforma.
- [ ] **Inicio de sesión:** Una persona registrada puede iniciar sesión.
...
## Valor Entregado
Permite que la plataforma reconozca usuarios registrados y siente la base para asociar sus splits a una cuenta.
